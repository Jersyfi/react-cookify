        ...
        <div className="overflow-hidden">
            <div className="bg-[var(--c-c-bar-bg-color)] hover:bg-[var(--c-c-bar-bg-hover-color)] rounded-[var(--c-c-bar-border-radius)] p-3 flex gap-3">
                <div onClick={handleToogleCollapse} className="flex items-center gap-1 mr-auto font-bold cursor-pointer text-[var(--c-c-bar-text-color)]">
                    ...
                    {type.title}
                    {type.body?.length > 0 && (
                        <span className="inline-block relative bg-[var(--c-c-bar-badge-bg-color)] rounded-[var(--c-c-bar-badge-border-radius)] px-2 py-0.5 text-xs text-[var(--c-c-bar-badge-text-color)] font-bold leading-4">{type.body.length}</span>
                    )}
                </div>
            ...
            <div className={'px-[var(--c-c-extend-padding)] ' + (collapse ? '' : 'hidden')}>
