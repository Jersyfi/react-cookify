...
export const Footer: React.FC = () => {
    ...
    return (
        <div className="relative sm:rounded-b-[var(--c-border-radius)] grow-0 bg-[var(--c-bg-secondary-color)] px-4 py-3 sm:px-6 grid gap-3 border-t-2 border-[var(--c-border-color)]">
